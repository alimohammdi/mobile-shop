                ...
                <section class="panel">
                    <header class="panel-heading">
                        ...
                        <table class="table table-striped border-top" >
                            ...
                            <?php
                            $n = 1;
                            $sql = "SELECT  id,fa_title,category,price,available,sold,label  FROM   product_janeb   order by id DESC ";
                            if (isset($conn)) {
                                    ...
                                    if($count > 0){
                                        while($rows = mysqli_fetch_assoc($res)){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= '../show-test-product.php' ?>?id=<?= $id ?>&category=<?= $label ?>"><button type="button" class="btn btn-warning">نمایش</button></a>
                                                    <a href="<?= asset('update-product-janebi.php')?>?id=<?= $id ?>"><button type="button" class="btn btn-info">ویرایش</button></a>
                                                    <a href="<?= asset('delete-product-janebi.php')?>?id=<?= $id ?>"><button type="button" class="btn btn-danger">حذف</button></a>
                                                </td>
                                            </tr>
                                            </tbody>
                                            <?php
