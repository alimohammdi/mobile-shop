            ...
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading">
                        <h2>مدیریت محصولات قاب و گلس</h2>
                        <?php
                        ...
                        <table class="table table-striped border-top" >
                            ...
                            <?php
                            $n = 1;
                            $sql = "SELECT  id,fa_title,category,price,available,sold  FROM   product_ghab";
                            if (isset($conn)) {
                                        ...
                                        while($rows = mysqli_fetch_assoc($res)){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?= asset('edite-product-gh.php')?>?id=<?= $id ?>"><button type="button" class="btn btn-info">ویرایش</button></a>
                                                    <a href="<?= asset('delete-product-gh.php')?>?id=<?= $id ?>"><button type="button" class="btn btn-danger">حذف</button></a>
                                                </td>
                                            </tr>
                                            </tbody>
                                            <?php
